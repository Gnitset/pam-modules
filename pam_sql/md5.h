...
#define md5_buffer _pam_sql_md5_buffer
#define md5_finish_ctx _pam_sql_md5_finish_ctx
#define md5_init_ctx _pam_sql_md5_init_ctx
#define md5_process_block _pam_sql_md5_process_block
#define md5_process_bytes _pam_sql_md5_process_bytes
#define md5_read_ctx _pam_sql_md5_read_ctx
#define md5_stream _pam_sql_md5_stream
